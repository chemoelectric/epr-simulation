...
The relative intensity of the light in a polarizer’s channel (see the
[Law of
...
is, no normalization is needed. This covariance, and thus the
correlation coefficient, can be computed (with some care) as follows—
